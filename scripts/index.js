...
export const changeButton = document.querySelector(".profile__button-change");
...
export const infoName = document.querySelector(".profile__title");
export const infoClass = document.querySelector(".profile__subtitle");
...
const popupFormInfo = document.querySelector(".popup__container_info");
