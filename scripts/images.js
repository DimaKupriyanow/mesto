...
// const templateCard = document.getElementById('images-card'); // находим темплейт в дереве
...
//   imgHtmlElement.querySelector('element__image').addEventListener('click', () => {
//     openPopup(data)
//   });
...
//const imageTemplate = document.getElementById("images-card");
//  const editImageButton = document.querySelector(".buttonAddImage");
//  const editImageForm = document.querySelector(".popup_type_more_image");

//  const createImage = (imageData) => {
//   const imageHtmlElement = imageTemplate.content
//     .querySelector(".element")
//     .cloneNode(true);
    
//     const imageNameTwo = imageHtmlElement.querySelector(".element__image");
//   const ImageTwo = imageHtmlElement.querySelector(".element__title");
...
// const savePopupImage = morePopupImage.querySelector('.popup__container-image');
// const savePopupImageTitle = morePopupImage.querySelector('.popup__title-image');
// const myImageButton = document.querySelector('.element__image');

// function createCard (data) {
//   const htmlElement = template.cloneNode(true)
//   htmlElement.querySelector('element__image').src = data.link;
//   htmlElement.querySelector('element__title').textContent = data.name;

  

//   htmlElement.querySelector('element__image').addEventListener('click', () => openPopup(data))
  
//   const myImageButton = htmlElement.querySelector('.element__image');
//   const myImageTitle = htmlElement.querySelector('.element__title');

//   myImageButton.addEventListener("click", () => {
//   openPopup(myImageButton);
//   templateCard.classList.add('popup_opened')
  
  
//   morePopupImage.querySelector('element__image').src = data.link;
//   morePopupImage.querySelector('element__title').textContent = data.name;
//   morePopupImage.classList.add('popup_opened')
// });
// }


// myImageButton.addEventListener("click", () => {
//   openPopup(morePopupImage);
//   templateCard.classList.add('popup_opened')
